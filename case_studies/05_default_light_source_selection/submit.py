"""Default light-source selection case study: drive both CLI and HTTP API.

Demonstrates restricting the analysis to ``LEDB1`` (a built-in source
that is *not* in the default set), via ``--default-light-sources LEDB1``
on the CLI and ``default_light_sources=LEDB1`` on the API.
...
CLI_OPTIONS: list[str] = [
    "--default-light-sources", "LEDB1,LEDB4",
    "--plot-dpi", "400",
]
API_FORM: dict[str, str] = {
    "default_light_sources": "LEDB1,LEDB4",
    "plot_dpi": "400",
}
