"""Plot DPI case study: drive both the CLI and the HTTP API.

Demonstrates raising the TIFF plot resolution from the default ``400``
to ``600`` for publication-resolution exports, via ``--plot-dpi 600`` on
the CLI and ``plot_dpi=600`` on the API.
