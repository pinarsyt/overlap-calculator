"""Broadening-sigma case study: drive both the CLI and the HTTP API.

Demonstrates narrowing the Gaussian / Lorentzian broadening from the
default ``0.30`` eV down to ``0.20`` eV, via ``--sigma-ev 0.20`` on the
CLI and ``sigma_ev=0.20`` on the API.
