"""Marcus–Hush width case study: drive both the CLI and the HTTP API.

Demonstrates replacing the fixed broadening sigma with the classical
Marcus–Hush Gaussian width via ``--sigma-mode marcus-hush``,
``--reorganization-ev 0.30``, and ``--temperature-k 298.15`` on the CLI,
...
CLI_OPTIONS: list[str] = [
    ...
    "--sigma-mode", "marcus-hush",
    "--reorganization-ev", "0.30",
