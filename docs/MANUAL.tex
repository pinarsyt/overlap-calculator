...
\date{Version 1.0.0 \quad\textbullet\quad 2026-05-01}
...
\begin{longtable}{@{}p{3.4cm}p{3.6cm}p{8.6cm}@{}}
\toprule
...
\begin{longtable}{@{}>{\RaggedRight}p{5.0cm}>{\RaggedRight}p{3.8cm}>{\RaggedRight}p{6.8cm}@{}}
\toprule
\textbf{Flag} & \textbf{Default} & \textbf{Description} \\
\midrule
\endhead
...
\begin{longtable}{@{}>{\RaggedRight}p{5.0cm}>{\RaggedRight}p{3.0cm}>{\RaggedRight}p{7.6cm}@{}}
\toprule
...
\begin{longtable}{@{}>{\RaggedRight}p{2.6cm}>{\RaggedRight}p{2.8cm}>{\RaggedRight}p{4.2cm}>{\RaggedRight}p{5.4cm}@{}}
\toprule
...
\begin{longtable}{@{}p{2.8cm}p{1.6cm}p{11cm}@{}}
\toprule
...
\begin{itemize}
  \item Exactly one wavelength column; accepted aliases
        ...
        \texttt{wavelength\_nm}, \texttt{lambda}, \texttt{wl},
...
different scientific questions: \texttt{absorbed\_fraction} tracks the
...
yield; \texttt{shape\_overlap} is a brightness-independent spectral
...
One row per \texttt{(sample\_id, light\_source\_name)} pair. Shared
columns: \texttt{source\_type}, \texttt{sample\_id},
\texttt{light\_source\_name}, \texttt{plot\_ms}. Each broadening method
contributes a five-column block (\texttt{gaussian\_parse\_tddft\_ms},
\texttt{gaussian\_broadening\_ms}, \texttt{gaussian\_light\_source\_ms},
\texttt{gaussian\_integrals\_ms}, \texttt{gaussian\_total\_sample\_ms},
and the matching \texttt{lorentzian\_*} quintuplet). The row ends with
\texttt{total\_pair\_ms} (sum of both methods' \texttt{total\_sample\_ms})
and \texttt{total\_with\_plot\_ms} (\texttt{total\_pair\_ms +
plot\_ms}).
...
\begin{longtable}{@{}p{2cm}p{8cm}p{5.2cm}@{}}
\toprule
...
\begin{longtable}{@{}>{\RaggedRight}p{7.2cm}>{\RaggedRight}p{3.6cm}>{\RaggedRight}p{4.8cm}@{}}
\toprule
